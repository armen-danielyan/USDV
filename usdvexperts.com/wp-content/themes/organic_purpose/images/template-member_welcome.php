...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                    ...
                    <div class="row">
    <div class="col-md-8">
        <div id="welcome_text"><p style="padding:0px;">The GUSGC Web Application will assist you in completing and submitting your application for the Green Card Lottery.<br>You can access the fields for submission on the left toolbar or via the icons below.<br> Please fill in all required details and upload your personal photo.<br>Once all fields have been completed, the "<strong>Submit Application</strong>" button will be enabled.</p><h3>Complete your appliaction in 2 easy steps:</h3></div>
		...
		<div class="tile-stats tile-first tile-red">		
		<div class="num">
            <!-- <span class="icoPersonal">k</span> -->
            <span class="icos icos1"></span>
            <?php _e('Personal Information', 'organicthemes'); ?></div>
			<p>Click here to fill in your application</p>	</div>
		</div>
		</a>
		...
		<div class="tile-stats tile-red" style="padding-bottom:23px;">		
		<div class="num">
		...
		<p style="margin: 0 0 8.5px;font-size: 12px;">*Our automated system will help you with the preliminary steps of the Green Card Lottery application. However, input and formatting errors may go undetected by this system, and thus we cannot guarantee a successful submission through our automated service alone.</p>
