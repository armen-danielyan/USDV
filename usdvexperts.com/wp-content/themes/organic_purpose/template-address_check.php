<?php
/**
 * Template Name: Auto Complite Check
 */
get_header();
global $wpdb;
...
<script>
    $(function() {
        ...
        form.steps({
            ...
            {
                //disabled done step
                $('.steps').find('.done').addClass('disabled');
                                        ...
                                        <ul id="gform_fields_1" class="gform_fields top_label form_sublabel_below description_below"> 
                                            ...
                                            <li id="field_1_2" class="gfield field_sublabel_below field_description_below">
                                                ...
                                                <div class="ginput_complex ginput_container has_street has_street2 has_city has_state has_zip has_country ginput_container_address" id="input_1_2">
                                                    ...
                                                    <span class="ginput_left address_zip" id="input_1_2_5_container">
                                                        <input id="been_to_usa" name="been_to_usa" type="text" class="required" tabindex="5">
                                        ...
                                        <ul id="gform_fields_1" class="gform_fields top_label form_sublabel_below description_below"> 
                                            ...
                                            <li id="field_1_2" class="gfield field_sublabel_below field_description_below">
                                                ...
                                                <div class="ginput_complex ginput_container has_street has_street2 has_city has_state has_zip has_country ginput_container_address" id="input_1_2">
                                                    ...
                                                    <span class="ginput_left address_zip" id="input_1_2_5_container">
                                                        <input id="spouse_first_name" name="spouse_first_name" type="text" class="required" tabindex="1">
                                                        <label for="spouse_first_name" id="input_1_2_5_label">Spouse First Name *</label>
                                                    </span>
                                                    <span class="ginput_right address_country" id="input_1_2_6_container">
                                                        <input id="spouse_last_name" name="spouse_last_name" type="text" class="required" tabindex="2">
                                                        <label for="spouse_last_name" id="input_1_2_6_label">Spouse Last Name *</label>
                                                    </span>
                                                    ...
                                                    <span class="ginput_right address_state" id="input_1_2_4_container">
                                                        <select class="required" name="spouse_education_level" id="spouse_education_level" tabindex="4">
                                                                ...
                                                                <option value="some university courses">Some University Courses</option>
                                                                <option value="university degree">University Degree</option>
                                                                <option value="some graduate level courses">Some Graduate Level Courses</option>
                                                                <option value="master degree">Master Degree</option>
                                                                <option value="some doctorate level courses">Some Doctorate Level Courses</option>
                                                    ...
                                                    <span class="ginput_right address_state" id="input_1_2_4_container">
                                                        <input id="no_of_children" name="no_of_children" type="text" class="required" tabindex="6">
